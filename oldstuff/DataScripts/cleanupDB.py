...
def main(argv):
    ...
    for data in datainfoidlist:
        ...
        if lenstream > 1:
            ...
            reportdict[data] = 'starting, step1'
            ...
            if sr < 0.9 and autofilter in [1,2,3]:
                ...
                try:
                    print("Finished seconds filtering for {}: {} data points ".format(datainfoid, stream.length()[0]))
                    dbdelete(db,datainfoid,samplingrateratio=samplingrateratio)
                    print("Now deleting old entries in database older than %s days" % str(int(sr*samplingrateratio)))
                    reportdict[data] = 'starting, step1, step2 (1Hz filter)'
                except:
                    print("A problem occurred while saving archive file of 1 second data")
            if sr < 59.0 and autofilter in [2,3]:
                ...
                try:
                    ...
                    reportdict[data] = 'starting, step1, step2 (1Hz filter), step3'
                except:
            ...
            if sr < 3500.0 and autofilter in [3]:
                ...
                try:
                    ...
                    reportdict[data] = 'starting, step1, step2, step3, step4'
                except:
                    print("A problem occurred while removing old inputs from database")


    print("---------------------------------------------------------------")
    print("Database contents successfully cleaned:")
    for data in datainfoidlist:
        print ("- {}: {} --- success".format(data, reportdict[data]) 
    print("---------------------------------------------------------------")
