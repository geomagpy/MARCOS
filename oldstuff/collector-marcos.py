...
remotedb = {'host':dbhost, 'user': dbuser, 'passwd': dbpasswd, 'name':'testdb'}
localdb = {'host':dbhost, 'user': dbuser, 'passwd': dbpasswd, 'name':'cobsdb'}
...
subscription.datainfoid = 'LEMI025_22_0002_0001'
